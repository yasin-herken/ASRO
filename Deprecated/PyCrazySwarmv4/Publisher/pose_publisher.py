...
def send_to_data_ros(uri,timestamp, data_org, logconf):
    ...
    print("Team Name: ", uav_inf.team_name, "\nUav Name: ", uav_inf.uav_name)
    print("Roll: ", uav_inf.rpy.roll,"\nPitch: ", uav_inf.rpy.pitch)
    print("Yaw: ",uav_inf.rpy.roll,"\nx: ", uav_inf.pose.x, "\ny: ",uav_inf.pose.y)
    print("z: ", uav_inf.pose.z)
